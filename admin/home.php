...
<style>
   span.float-right.summary_icon {
    ...
    .gradient-text {
        background-image: linear-gradient(0deg, #fff508 0%, #eccb25 30%, #ff7b11 66%, #ff0002 100%) !important;
	...
	<div class="row mt-3 mx-3">
        <div class="col-lg-12 tables">             
            <div class="datetime">
                Hola, <?php echo ucwords($_SESSION['login_name'])?>!
                <hr>
                <div class="time gradient-text"></div>
                <div class="date"></div>
            </div> 			
        </div>
    </div>
