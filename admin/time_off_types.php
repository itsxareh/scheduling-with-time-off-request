    ...
    <div class="col-lg-8 tables">
            <div class="card">
                <div class="card-header">
                    <b>Time-off Types</b>
                    <span><button class="btn btn-primary btn-block btn-sm col-sm-2 float-right" type="button" id="create_new">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-title="Action" class="text-center">
                                <button class="btn btn-sm btn-outline-primary edit_data" href="javascript:void(0)" type="button" data-id="<?php echo $row['id'] ?>" >Edit</button>
...
$(document).ready(function() {
    ...
    $('#print_table').click(function(){
        var nw = window.open("print_time_off_types.php","_blank","height=500,width=800")
        setTimeout(function(){
            nw.print()
            setTimeout(function(){
                nw.close()
...
function delete_leave_type($id) {
    ...
    $.ajax({
        ...
        success: function(resp) {
            if (resp) {
                alert_toast("Leave type deleted successfully.", 'success')
                setTimeout(function(){
                    location.reload();
                }, 100) 
            } else {
